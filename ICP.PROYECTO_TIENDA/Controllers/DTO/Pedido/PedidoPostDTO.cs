...
namespace Icp.TiendaApi.Controllers.DTO.Pedido
{
    public class PedidoPostDTO
    {
        ...
        [StringLength(20, ErrorMessage = "La longitud máxima de Ciudad debe ser de 30 caracteres")]
        public string Ciudad { get; set; }
        [Required(ErrorMessage = "Telefono requerido")]
        [FiltroTelefono]
        public string Telefono { get; set; }
        [Required(ErrorMessage = "Contacto requerido")]
        [StringLength(20, ErrorMessage = "La longitud máxima de Contacto debe ser de 15 caracteres")]
        public string Contacto { get; set; }
        [Required(ErrorMessage = "Direccion requerida")]
        [StringLength(40, ErrorMessage = "La longitud máxima de Direccion debe ser de 30 caracteres")]
